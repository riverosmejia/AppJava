...
public final class DateChooser extends javax.swing.JPanel {
    ...
    public static void main(String[] args) {
        // Crear una instancia de DateChooser
        DateChooser dateChooser = new DateChooser();

        // Crear un JTextField para asignar como referencia al DateChooser
        JTextField textField = new JTextField();

        // Establecer el JTextField como referencia del DateChooser
        dateChooser.setTextRefernce(textField);

        // Crear un JFrame para mostrar el DateChooser
